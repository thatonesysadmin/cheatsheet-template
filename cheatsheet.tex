...
\begin{center}
     {\Large{\textbf{\color{black}CSS3 Cheatsheet}}} \\
 \today
\end{center}
...
%
% EXAMPLE:
% \toprule \<abbreviation> & <definition> & \code<example code>
%
\section{Abbreviations}

\begin{tabular}{lll}
    \toprule \textbf{abbreviation} & \textbf{description} & \textbf{example} \\ 
...
\section{HTML basic tags}
    \bcode{<!DOCTYPE html>} define document as an html document\\
